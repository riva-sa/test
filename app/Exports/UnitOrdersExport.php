...
class UnitOrdersExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($unitOrder): array
    {
        return [
            ...
            $unitOrder->email,
            $unitOrder->phone,
            $unitOrder->statusLabel(),
            $unitOrder->marketing_source ?? 'N/A',
            $unitOrder->assignedSalesUser ? $unitOrder->assignedSalesUser->name : 'N/A',
            $unitOrder->waiting_list_unit_type ?? 'N/A',
            $unitOrder->message,
