    ...
    <div style="max-width:600px; margin:0 auto; padding:32px 16px;">
        <div style="background:#ffffff; border-radius:16px; padding:32px; border:1px solid #e4e4e7;">
            ...
            <p style="font-size:14px; color:#3f3f46; line-height:1.8;">
                شكراً لتقديمك على وظيفة <strong>{{ $application->jobPosting->title }}</strong> لدى ريفا العقارية.
            </p>
            <p style="font-size:14px; color:#3f3f46; line-height:1.8;">
                تم استلام طلبك بنجاح، وسيقوم فريق التوظيف لدينا بمراجعته والتواصل معك في حال كان ملفك مناسباً لمتطلبات الوظيفة.
            </p>

            <div style="background:#f4f4f5; border-radius:12px; padding:16px; margin:16px 0;">
                <p style="font-size:13px; color:#3f3f46; margin:0 0 4px;"><strong>الوظيفة:</strong> {{ $application->jobPosting->title }}</p>
            ...
            <p style="font-size:14px; color:#3f3f46; line-height:1.8; direction:ltr; text-align:left;">
                Thank you for applying for the <strong>{{ $application->jobPosting->title_en ?: $application->jobPosting->title }}</strong> position at Riva Real Estate.
                <br>
                Your application has been received successfully. Our recruitment team will review it and contact you if your profile matches the role requirements.
            </p>
