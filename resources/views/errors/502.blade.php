...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('title', 'بوابة غير صالحة - ريفا العقارية')</title>
                ...
                <div class="container pt-15 pt-md-20" style="height:83vh">
                    <div class="row m-auto">
                        ...
                        <div class="col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center">
                            <h1 class="mb-3">عذراً، الخادم لا يستجيب حالياً (502).</h1>
                            <p class="lead mb-7 px-md-12 px-lg-5 px-xl-7">نواجه حالياً ضغطاً كبيراً على الخادم. يرجى المحاولة مرة أخرى بعد قليل.</p>
                            <a href="{{ route('frontend.home') }}" class="btn btn-primary rounded-pill">تحديث الصفحة</a>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
