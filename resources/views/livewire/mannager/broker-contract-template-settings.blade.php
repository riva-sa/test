     ...
     x-data="{
        ...
        async initPdf() {
            ...
            const loadingTask = pdfjsLib.getDocument({
                ...
                // Render glyphs directly from the embedded font by glyph-id instead
                // of via CSS @font-face. The template is generated by mPDF with
                // pre-shaped CID Arabic (Identity-H); @font-face lets the browser
                // re-shape it and garbles the text. Drawing the glyph paths directly
                // reproduces the PDF exactly — correct Arabic.
